...
export default function ClientsIndex({ clients, searchTerm, flash }: PageProps) {
  ...
  const [prevFlashLink, setPrevFlashLink] = useState<string | undefined>(undefined)

  if (flash?.generatedLink && flash.generatedLink !== prevFlashLink) {
    setPrevFlashLink(flash.generatedLink)
              ...
              <Modal.Dialog>
                ...
                <Modal.Body className="space-y-4">
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Este link é <strong>válido por 24 horas</strong>. Envie para o cliente realizar
                    o cadastro.
                  </p>
